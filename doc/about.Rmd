...
Our data come from the [John Hopkins University dataset](https://github.com/CSSEGISandData/COVID-19), which is updated daily.  Country to continent associations come from [this file](https://github.com/dbouquin/IS_608/blob/master/NanosatDB_munging/Countries-Continents.csv).  These data report the cumulative number of infections ($I_t$) and number of deaths ($D_t$) in each country.  The raw case numbers are simply a report of their raw numbers for the selected country at the current date.
