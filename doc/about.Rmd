...
When public health interventions are rapidly changing the growth rate, this can be seen as deviations from the expected straight line on the log-plot.  In these situations, when growth rate is declining rapidly (the curve is flattening), forecasts from this exponential model (averaging growth over the last ten days) will be biased upwards.  We will introduce a slider shortly allowing you to adjust the window over which growth rate is averaged, so you can get a sense of how recent shifts might affect the forecast.
