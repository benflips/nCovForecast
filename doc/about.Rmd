...
Daily deaths ($F_t$) is a simple calculation ($F_t = D_t -D_{t-1}$) where ($D_t$) is the cumulative number of deaths at time $t$, and ($D_{t-1}$) is the cumulative number of deaths the day before. 
